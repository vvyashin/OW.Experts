...
namespace OW.Experts.Domain.Tests
{
    ...
    {
        private SessionOfExperts _sessionFake;
        ...
        public void IsPhaseCompleted_CurrentSessionPhaseDoesNotEqualLastCompletedPhase_ReturnFalse(
            ...
            SessionPhase? lastCompletedPhase)
        {
            var expert = CreateExpert();
            SetCurrentSessionPhase(currentPhase);
        ...
        public void SetTypeForAssociation_AssociationWithTheIdDoesNotExist_Throw()
        {
            ...
            Assert.Throws<InvalidOperationException>(
                () => expert.SetTypeForAssociation(
                    GeneratedGuids.First,
                    Substitute.For<NotionType>(),
                    null));
        }
        ...
        public void SetTypeForAssociation_AssociationWithTheIdExists_SetTypes()
        {
            ...
            association.Received(1).UpdateTypes(Arg.Is(notionType), Arg.Is("offerType"));
        }
        ...
        public void SetTypeForRelation_RelationWithTheIdDoesNotExist_Throw()
        {
            ...
            Assert.Throws<InvalidOperationException>(
                () => expert.SetTypesForRelation(
                    GeneratedGuids.First,
                    Substitute.For<RelationType>().Enumerate(),
                    null));
        }
        ...
        public void SetTypeForRelation_RelationWithTheIdExists_SetTypes()
        {
            ...
            relation.Received(1).UpdateTypes(Arg.Is(relationTypes), Arg.Is("offerType"));
        }
        ...
        public void TestToString()
        {
            ...
            actual.Should().Be($"Name - Сессия: {_sessionFake}");
        }
        ...
        {
            return new ExpertWithCollections(
                "name",
                _sessionFake,
                associations,
                new Relation[0]);
        ...
        private Expert CreateExpert(IEnumerable<Relation> relations)
        {
            ...
            return new ExpertWithCollections("name", _sessionFake, new Association[0], relations);
        }
