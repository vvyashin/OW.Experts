...
namespace Domain.Services.Tests
{
    ...
    public class SemanticNetworkServiceTests
    {
        ...
        private SemanticNetworkService CreateServiceUnderTest()
        {
            ...
            return new SemanticNetworkService(FakeNodeRepository, FakeVergeRepository, FakeNotionTypeRepository,
        ...
        {
            SemanticNetworkService serviceUnderTest = CreateServiceUnderTest();
        ...
        public void CreateSemanticNetworkFromNodeCandidates_CreateNodeForRootAndForNodeCandidates()
        {
            ...
            FakeNodeRepository.Received(1).AddOrUpdate(Arg.Is<Node>(x => x.Notion == "baseNotion" && x.Type == generalType));
        ...
        public void CreateSemanticNetworkFromNodeCandidates_FilteredByIsSaveAsNode()
        {
            ...
            FakeNodeRepository.Received(1).AddOrUpdate(Arg.Is<Node>(x => x.Notion == "notion" && x.Type == notionType));
            FakeNodeRepository.DidNotReceive().AddOrUpdate(Arg.Is<Node>(x => x.Notion == "notion2" && x.Type == notionType));
        }
        ...
        public void CreateSemanticNetworkFromNodeCandidates_CreateVergesFromRootToEachNodeCandidateSavedAsNode()
        {
            ...
            FakeVergeRepository.Received(1).AddOrUpdate(Arg.Is<Verge>(x => 
                x.SourceNode.Notion == "baseNotion" && x.DestinationNode.Notion == "notion" && x.Type == generalRelationType));
            FakeVergeRepository.Received(1).AddOrUpdate(Arg.Is<Verge>(x =>
                x.SourceNode.Notion == "notion" && x.DestinationNode.Notion == "baseNotion" && x.Type == generalRelationType));
        }
        ...
        public void CreateSemanticNetworkFromNodeCandidates_IfVergeExists_UpdateItAndLinkSession()
        {
            ...
            FakeVergeRepository.GetByNodesAndTypes(Arg.Is<Node>(x => x.Notion == "source"), 
                Arg.Is<Node>(x => x.Notion == "destination"), Arg.Any<RelationType>())
                .Returns(verge);
        ...
        public void SaveRelationsAsVergesOfSemanticNetwork()
        {
            ...
            {
                new GroupedRelation() {Source = source, Destination = destination, Type = type,
        ...
        public void SaveRelationsAsVergesOfSemanticNetwork_IfVergeExists_UpdateIt()
        {
            ...
            var groupedRelations = new[]
            {
                new GroupedRelation() {Source = source, Destination = destination, ExpertCount = 1,
